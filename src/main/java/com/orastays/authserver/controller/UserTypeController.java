...
@CrossOrigin(origins = "*")
//@RequestMapping("/api")
@Api(value = "User Type", tags = "User Type")
public class UserTypeController {

	@PostMapping(value = "/file-upload", produces = "application/json", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    public ResponseEntity<String> uploadFile(
            ...
            @RequestPart("file") MultipartFile file , @RequestBody UserModel u) {
        try {
